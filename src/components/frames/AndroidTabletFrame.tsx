...
export default function AndroidTabletFrame({ url, device, baseWidth, baseHeight, scale }: FrameProps) {
					...
					{(panelMode === "fixed" || (panelMode === "float" && !isHovered)) && (
						...
						>
							...
							<div className="flex flex-row items-center h-9 px-1.5 bg-white">
								...
								{/* Address bar */}
								<div className="flex flex-row items-center flex-grow h-7 mx-2 rounded-full bg-gray-100 overflow-hidden">
									...
									<div className="flex-grow text-sm whitespace-pre">
