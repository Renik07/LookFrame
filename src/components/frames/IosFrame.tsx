...
export default function IosFrame({
  ...
  return (
    ...
    >
          ...
          <div className="flex items-center justify-between h-[100%]">
            ...
            >
              <g opacity=".35" fill="none">
                <path d="M45 .033h16.7c1.5 0 2.7 1.2 2.7 2.7v6c0 1.5-1.2 2.7-2.7 2.7H45c-1.5 0-2.7-1.2-2.7-2.7v-6c0-1.5 1.2-2.7 2.7-2.7z"></path>
                <path
                  d="M45 .533h16.7c1.2 0 2.2 1 2.2 2.2v6c0 1.2-1 2.2-2.2 2.2H45c-1.2 0-2.2-1-2.2-2.2v-6c0-1.3 1-2.2 2.2-2.2z"
                  stroke="#000"
                  strokeMiterlimit="10"
                ></path>
              </g>
              <path
                d="M65.3 3.7v4c.8-.3 1.3-1.1 1.3-2s-.5-1.7-1.3-2"
                opacity=".4"
              ></path>
              <path d="M45.7 2H61c.7 0 1.3.6 1.3 1.3V8c0 .7-.6 1.3-1.3 1.3H45.7c-.7 0-1.3-.6-1.3-1.3V3.3c-.1-.7.5-1.3 1.3-1.3zM29.7 11c-.1 0-.2 0-.2-.1l-2-2c-.1-.1-.1-.3 0-.4 1.3-1.1 3.1-1.1 4.4 0 0 0 .1 0 .1.1s0 .2-.1.2l-2 2-.2.2z"></path>
              <path d="M33.2 7.4c-.1 0-.2 0-.2-.1-1.9-1.7-4.7-1.7-6.6 0-.1.1-.1.1-.2.1s-.2 0-.2-.1l-1.2-1.2c-.1-.1-.1-.3 0-.5 2.7-2.6 7-2.6 9.8 0 .1.1.1.1.1.2s0 .2-.1.2l-1.2 1.2c-.1.2-.1.2-.2.2z"></path>
      ...
      {panelMode !== "off" && (
        <div
          className={`absolute bottom-0 left-0 w-full h-auto bg-gray-100 transition-all duration-300 ${
            panelMode === "float" && isHovered ? "p-0" : "p-2 pl-5 pr-5"
          }`}
          style={{
            height: bottomHeight,
          }}
        >
          {/* address panel */}
          <div
            className={`bg-[#8e8e931a] flex items-center justify-between ${
              panelMode === "float" && isHovered
                ? "h-[100%] p-0 rounded-none"
                : "h-[45%] p-2 rounded-xl"
            }`}
          >
            {(panelMode === "fixed" ||
            ...
            {(panelMode === "fixed" ||
              ...
              >
                <path
                  d="M7.578 8.415c.22 0 .387-.07.519-.202l3.419-3.445a.726.726 0 00.228-.537.76.76 0 00-.228-.536L8.096.224a.676.676 0 00-.518-.22c-.395 0-.703.325-.703.738a.8.8 0 00.193.51l2.145 2.092a7.817 7.817 0 00-1.354-.115 7.337 7.337 0 00-7.374 7.366 7.367 7.367 0 007.383 7.391 7.365 7.365 0 007.374-7.391.72.72 0 00-.747-.747c-.422 0-.703.316-.703.747a5.914 5.914 0 01-5.924 5.941 5.915 5.915 0 01-5.932-5.941 5.895 5.895 0 015.923-5.933c.607 0 1.152.044 1.635.14l-2.417 2.4a.707.707 0 00-.202.492c0 .413.308.721.703.721z"
                  fill="#000"
                ></path>
              </svg>
            )}
          ...
          {(panelMode === "fixed" || (panelMode === "float" && !isHovered)) && (
            <div className="flex items-center justify-between h-[55%]">
              {/* arrow back */}
              {
                ...
                >
                  <path
                    d="M9.415 18.22a.92.92 0 00.666.277c.533 0 .933-.4.933-.933a.974.974 0 00-.266-.666L3.283 9.597l7.465-7.301a.994.994 0 00.266-.667.92.92 0 00-.933-.943.92.92 0 00-.666.277L1.293 8.91a.9.9 0 00-.307.687c0 .256.102.492.297.687l8.132 7.936z"
                    fill="#2E7CF6"
                  ></path>
                </svg>
              }
              {/* arrow next */}
              {
                ...
                >
                  <path
                    d="M10.1 18.5c-.3 0-.5-.1-.7-.3l-8.1-7.9c-.2-.2-.3-.4-.3-.7 0-.3.1-.5.3-.7L9.4 1c.2-.2.4-.3.7-.3.5 0 .9.4.9.9 0 .2-.1.5-.3.7L3.3 9.6l7.5 7.3c.2.2.3.4.3.7-.1.5-.5.9-1 .9z"
                    fill="#cecece"
                  ></path>
                </svg>
              }
              ...
              {/* tabs */}
              {
                ...
                >
                  <path
                    d="M3.96 17.626h1.898v1.764c0 2.112 1.077 3.178 3.22 3.178h10.95c2.144 0 3.22-1.066 3.22-3.178V8.49c0-2.102-1.076-3.169-3.22-3.169h-1.896v-1.66c0-2.113-1.087-3.18-3.22-3.18H3.961C1.808.481.74 1.548.74 3.661v10.796c0 2.113 1.067 3.169 3.22 3.169zm.021-1.65c-1.025 0-1.589-.544-1.589-1.61V3.751c0-1.066.564-1.62 1.59-1.62h10.9c1.014 0 1.599.554 1.599 1.62v1.57H9.078c-2.143 0-3.22 1.055-3.22 3.168v7.485H3.98zm5.127 4.941c-1.025 0-1.6-.553-1.6-1.62V8.582c0-1.066.575-1.61 1.6-1.61h10.9c1.015 0 1.59.544 1.59 1.61v10.726c0 1.056-.575 1.61-1.59 1.61h-10.9z"
                    fill="#2E7CF6"
                  ></path>
                </svg>
              }
