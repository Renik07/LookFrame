...
export default function IosFrame({ baseWidth, baseHeight, scale }: { baseWidth: number; baseHeight: number; scale: number }) {
	...
	return (
		...
		>
			{/* верхняя панель */}
			<div className="absolute top-0 left-0 w-full h-[30px] bg-gray-100 p-2">
			...
			/>
			{/* нижняя панель */}
			<div className={`absolute bottom-0 left-0 w-full h-auto bg-gray-100 ${isFloat ? "p-0 transition-all duration-300" : "p-2 pl-3 pr-3"}`}>
				{/* address panel */}
				...
				<div className={`flex items-center justify-between h-[50px] ${isFloat ? "transform translate-y-[100%] transition-all duration-300 hidden" : ""}`}>
					...
					{/* arrow next */}
					{<svg width="12" height="19" xmlns="http://www.w3.org/2000/svg" className=""><path d="M10.1 18.5c-.3 0-.5-.1-.7-.3l-8.1-7.9c-.2-.2-.3-.4-.3-.7 0-.3.1-.5.3-.7L9.4 1c.2-.2.4-.3.7-.3.5 0 .9.4.9.9 0 .2-.1.5-.3.7L3.3 9.6l7.5 7.3c.2.2.3.4.3.7-.1.5-.5.9-1 .9z" fill="#cecece"></path></svg>}
					{/* share */}
